...
#+begin_src emacs-lisp
  (let* ((file "actuator-emacs")
         (org-file (expand-file-name (concat file ".org") actuator-directory))
         (el-file  (expand-file-name file user-emacs-directory)))
    (require 'ob-tangle)
    (org-babel-tangle-file org-file nil "emacs-lisp")
    (byte-compile-file (concat el-file ".el"))
    (load el-file))
#+end_src
  ...
  (defun actuator-regenerate-complete-init ()
    "Ask to completely rebuild init."
      (let ((literate nil)
        ...
        (find-file (expand-file-name "actuator-emacs.el" user-emacs-directory)) ;;TODO
        (org-babel-tangle-jump-to-org)
