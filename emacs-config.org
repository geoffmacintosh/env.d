...
#+begin_src emacs-lisp
  ...
  ;;(run-with-idle-timer 120 t #'actuator-unpropertize-kill-ring)
#+end_src
...
#+begin_src emacs-lisp
  ;;(eval-when-compile (declare-function savehist-save "savehist"))
...
#+begin_src emacs-lisp :tangle no
  (when (boundp 'comp-async-report-warnings-errors)
    (csetq comp-async-report-warnings-errors nil))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (run-with-idle-timer 120 t #'org-agenda-to-appt)
