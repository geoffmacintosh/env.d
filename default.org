...
#+begin_src conf :tangle /sudo::/etc/postfix/sasl_passwd :var pass=password=(auth-source-pass-get 'secret "smtp.fastmail.com")
  [smtp.fastmail.com]:587 gmacintosh#fastmail.fm:$password
#+end_src
